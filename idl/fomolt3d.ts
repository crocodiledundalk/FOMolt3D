  ...
  "instructions": [
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "referrerState",
          "docs": [
            "Optional referrer's PlayerState in this round."
          ],
          "optional": true
        },
        {
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "dividendsPerKeyAccumulated",
            "docs": [
              "Scaled dividend accumulator (DIVIDEND_PRECISION scaling)"
            ],
            "type": "u128"
          },
          {
        ...
        "fields": [
          {
            "name": "admin",
            "docs": [
              "Admin authority — only this signer can update config or start round 0"
            ],
            "type": "pubkey"
          },
          {
          ...
          },
          {
            "name": "referralBonusBps",
            "docs": [
              "Referral bonus as BPS of dividend portion"
            ],
            "type": "u64"
          },
          {
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "round",
            "docs": [
              "Round number this state belongs to"
            ],
            "type": "u64"
          },
          {
            "name": "unclaimedDividendsLamports",
            "docs": [
              "Pending dividends not yet withdrawn (lamports)"
            ],
            "type": "u64"
          },
          {
          ...
          {
            "name": "lastDividendCheckpoint",
            "docs": [
              "Snapshot of accumulator at last dividend update"
            ],
            "type": "u128"
          },
          {
