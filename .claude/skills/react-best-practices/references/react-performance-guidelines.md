...
5. [Re-render Optimization](#5-re-render-optimization) — **MEDIUM**
   ...
   - 5.5 [Use Lazy State Initialization](#55-use-lazy-state-initialization)
   - 5.6 [Use Transitions for Non-Urgent Updates](#56-use-transitions-for-non-urgent-updates)
