...
|------|------|-------------|
| 6000 | GameNotActive | Round is not currently active |
| 6001 | GameStillActive | Cannot start new round while active |
...
| 6010 | ReferrerNotInRound | Referrer must be a participant in the current round |
